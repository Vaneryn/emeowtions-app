...
public class Recommender {
    ...
    public void generateStrategies() {
        ...
        // General
        ids.add("generalPositive1");
        ids.add("generalPositive2");
        ids.add("generalNegative1");
        ids.add("generalNegative2");
        // Age
        ids.add("ageKittenPositive");
        ids.add("ageKittenNegative");
        ids.add("ageAdultPositive");
        ids.add("ageAdultNegative");
        ids.add("ageSeniorPositive");
        ids.add("ageSeniorNegative");
        // Gender
        ids.add("genderMalePositive");
        ids.add("genderMaleNegative");
        ids.add("genderFemalePositive");
        ids.add("genderFemaleNegative");
        // Temperament
        ids.add("temperamentAffectionatePositive");
        ids.add("temperamentAffectionateNegative");
        ids.add("temperamentGentlePositive");
        ids.add("temperamentGentleNegative");
        ids.add("temperamentPlayfulPositive");
        ids.add("temperamentPlayfulNegative");
        // Activity Level
        ids.add("activityLowPositive");
        ids.add("activityLowNegative");
        ids.add("activityHighPositive");
        ids.add("activityHighNegative");
        // Background
        ids.add("backgroundDomesticPositive");
        ids.add("backgroundDomesticNegative");
        ids.add("backgroundStrayPositive");
        ids.add("backgroundStrayNegative");
        ids.add("backgroundFeralPositive");
        ids.add("backgroundFeralNegative");
        // Medical Conditions
        ids.add("medicalYesPositive");
        ids.add("medicalYesNegative");
        ...
        // General
        // General Positive
        strats.add(new BehaviourStrategy("",
